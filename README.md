...
git clone --branch v2alpha https://github.com/FlyBrainLab/NeuroMynerva.git
...
## Changes from V1
V2 of NeuroMynerva is a complete overhaul of V1, which was development when JupyterLab was still in beta phase (v0.33). A few key differences are highlighted below:
